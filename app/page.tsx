    ...
    <div>
      <header className="th-header">
        <div className="th-header-inner">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 28 }}>
            ...
            <a href="#trial" className="th-nav-cta">
              Start free trial
            </a>
          </div>
        </div>
      ...
      <footer style={{ background: "var(--footer-bg)", color: "rgba(247,244,236,.72)" }}>
        <div className="wrap" style={{ padding: "60px 24px 44px" }}>
          ...
          >
            <div>
              <p style={{ ...mono, fontSize: 11, letterSpacing: ".12em", textTransform: "uppercase", color: "var(--gold)", margin: "0 0 12px" }}>
                What&rsquo;s a top hand?
              </p>
              <p style={{ ...serif, fontSize: 20, lineHeight: 1.45, color: "var(--paper)", margin: 0, maxWidth: 460, textWrap: "pretty" }}>
